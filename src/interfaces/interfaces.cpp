...
Interfaces::Interfaces(){
	...
	this->pCHLClient = reinterpret_cast<CHLClient*>(GetInterface("/home/redacted/gmod/GarrysMod/bin/linux64/client_client.so", "VClient"));
	this->pEngineClient = reinterpret_cast<CEngineClient*>(GetInterface("/home/redacted/.local/share/Steam/steamapps/common/GarrysMod/bin/linux64/engine_client.so", "VEngineClient"));
	this->pClientEntityList = reinterpret_cast<CClientEntityList*>(GetInterface("/home/redacted/gmod/GarrysMod/bin/linux64/client_client.so", "VClientEntityList"));
	this->pLuaShared = reinterpret_cast<lua::ILuaShared*>(GetInterface("/home/redacted/.local/share/Steam/steamapps/common/GarrysMod/bin/linux64/lua_shared_client.so", "LUASHARED003"));
	this->pInputSystem = reinterpret_cast<CInputSystem*>(GetInterface("/home/redacted/.local/share/Steam/steamapps/common/GarrysMod/bin/linux64/inputsystem_client.so", "InputSystemVersion"));
	this->pEngineTrace = reinterpret_cast<IEngineTrace*>(GetInterface("/home/redacted/.local/share/Steam/steamapps/common/GarrysMod/bin/linux64/engine_client.so", "EngineTraceClient"));
	this->pEngineVgui = reinterpret_cast<void*>(GetInterface("/home/redacted/.local/share/Steam/steamapps/common/GarrysMod/bin/linux64/engine_client.so", "VEngineVGui"));
	this->pGameMovement = reinterpret_cast<CGameMovement*>(GetInterface("/home/redacted/.local/share/Steam/steamapps/common/GarrysMod/bin/linux64/client_client.so", "GameMovement"));
	this->pPrediction = reinterpret_cast<CPrediction*>(GetInterface("/home/redacted/.local/share/Steam/steamapps/common/GarrysMod/bin/linux64/client_client.so", "VClientPrediction"));

	// all these offsets and pattersns might be bad up now...
	...
	uintptr_t RandomSeed = reinterpret_cast<uintptr_t>(dlsym(dlopen("/home/redacted/.local/share/Steam/steamapps/common/GarrysMod/bin/linux64/libvstdlib_client.so", RTLD_NOLOAD | RTLD_NOW | RTLD_LOCAL), "RandomSeed"));
	...
	auto setPredSeedAddr = PatternScan::findFirstInModule("/home/redacted/gmod/GarrysMod/bin/linux64/client_client.so", "55 48 85 ff 48 89 e5 ? ? 8b ? ? 48 ? ?");
	...
	auto playSwimSoundAddr = PatternScan::findFirstInModule("/home/redacted/gmod/GarrysMod/bin/linux64/client_client.so", "48 8b ? ? ? ? ? 55 48 8b ? ? 48 89 e5 5d");
